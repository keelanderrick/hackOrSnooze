...
class StoryList {
  ...
  async addStory(user, {title, author, url}) {
    ...
    // make the story object and add it to the arrays it is a part of
  ...
  async deleteStory(user, storyId) {
    ...
    // remove the story from the arrays it may be in
    this.stories = this.stories.filter(sto => sto.storyId !== storyId);
    user.ownStories = user.ownStories.filter(sto => sto.storyId !== storyId);
